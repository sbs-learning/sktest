--**************************************************************************************************
--*                                                                                                *
--*             NextGen PUB ADMIN 1.0.0 Install Script (from empty schema)                          *
--*                                                                                                *
--*        NextGen PUB ADMIN 1.0.0 empty schema with control data.                                  *
--**************************************************************************************************
--* Revision History                                                                               *
--* YYYYMMDD Revisor 		Build 		Comment                                                    *
--* -------- ------- ----- ----------------------------------------------------------------------- *
--* 20210503 Kalyan Kumar      1         Created deployment script                                  *
--*                                                                                                *
--**************************************************************************************************                                                                           *
--**************************************************************************************************
...
call sbs_util.p_util_log_apply('INITIAL','1.0.0','NG_PUB_ADMIN','Release 1.0.0, installed from initial script ','pba_version',NULL);
