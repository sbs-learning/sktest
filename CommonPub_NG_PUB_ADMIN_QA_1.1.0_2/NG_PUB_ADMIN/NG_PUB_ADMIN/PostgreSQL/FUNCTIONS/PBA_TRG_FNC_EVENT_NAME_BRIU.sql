CREATE OR REPLACE FUNCTION pub_admin.PBA_TRG_FNC_EVENT_NAME_BRIU()
RETURNS TRIGGER 
LANGUAGE 'plpgsql'
AS
$$
	...
	WHEN OTHERS THEN
		...
		CALL sbs_util.error_handler
			(
				...
				in_error_message 	=> CONCAT(' Error in Procedure :- PBA_TRG_FNC_EVENT_NAME_BRIU(), ', CHR(10), ' SQLERRM :- ', SQLERRM),
				in_show_stack 		=> TRUE
			);
END;
$$;